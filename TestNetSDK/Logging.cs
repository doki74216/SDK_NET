...
namespace TestNetSDK
{
    class Logging
    {
        public static void loggingSerial(String bucketname1, String bucketname2)
        {
            System.Console.WriteLine("\nLoggingSerial testing!!");
            ...
            String logBucketName = bucketname2;
            ...
            config2.AddGrant(grantee, S3Permission.READ_ACP);
            config2.RemoveGrant(grantee, S3Permission.FULL_CONTROL);
            config2.WithGrants(new S3Grant().WithGrantee(new S3Grantee().WithCanonicalUser("canonicalidannyren", "annyren")).WithPermission(S3Permission.READ_ACP));
            ...
            //jerry add end
            DisableBucketLoggingRequest disableLoggingRequest = new DisableBucketLoggingRequest();
            disableLoggingRequest.WithBucketName(bucketName);
            disableLoggingRequest.WithLoggingConfig(config2);
            s3Client.DisableBucketLogging(disableLoggingRequest);
