    ...
    class MPU
    {
        ...
        //    DateTime dt30 = dt.AddDays(-30);//減少30天
            ...
            CopyPartResponse copyPartDateResult = s3Client.CopyPart(new CopyPartRequest().WithSourceBucket(bucketName).WithDestinationBucket(bucketName)
                .WithSourceKey(objectNameA).WithDestinationKey(objectNameB).WithPartNumber(1).WithUploadID(objectBUID).WithModifiedSinceDate(DateTime.Now.AddDays(-100)));
            ...
            String versionid = "4c35bec48deb481e86f4312253268445";
